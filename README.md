...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-12 10:14`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/44d3631a-c2ec-42cc-ac40-6dbb0a738adf.git
$ cd 44d3631a-c2ec-42cc-ac40-6dbb0a738adf
```
